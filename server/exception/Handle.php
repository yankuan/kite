...
class Handle
{
    ...
    protected $ignoreReport = [
        '\\server\\exception\\HttpException',
    ];
    ...
    protected function convertExceptionToResponse(Exception $exception)
    {
        ...
        if (APP_DEBUG) {
            ...
            $data = [
                ...
                'tables'  => [
                    ...
                    'serverPHP Constants'    => $this->getConst(),
                ],
            ];
        } else {
            ...
            if ($options['show_error_msg']) {
                // 不显示详细错误信息
                $data['message'] = $options['error_message'];
            } else {
                echo 0;
                exit();
            }
        ...
        ob_start();
        extract($data);
        include SERVER_PATH.'tpl'.DS.'think_exception_tpl';
        // 获取并清空缓存
